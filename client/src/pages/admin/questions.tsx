            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select
                    onValueChange={field.onChange}
                    defaultValue={field.value || (form.watch('type') === 'image_choice' ? 'image_grid' : 'standard')}
                  >
                    <FormControl>
                      <SelectTrigger>
                    ...
                    <SelectContent>
                      {form.watch('type') === 'image_choice' ? (
                        <>
                          <SelectItem value="image_grid">Gallery Grid</SelectItem>
                          <SelectItem value="image_cardstack">Card Stack 3D</SelectItem>
                        </>
                      ) : (
                        <>
                  ...
                  <FormDescription>
                    {form.watch('type') === 'image_choice' 
                      ? 'Choose how the image options will be displayed to users'
