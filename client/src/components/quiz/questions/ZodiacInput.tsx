        ...
        {revealZodiac && zodiacSign && (
          ...
          >
            <div className="flex justify-center mb-2">
              <div className="w-16 h-16 rounded-full bg-white border-2 border-[#d2b183] shadow-md flex items-center justify-center">
                <i className={`${zodiacSign.iconClass} text-[#d2b183] text-2xl`}></i>
              </div>
            </div>
