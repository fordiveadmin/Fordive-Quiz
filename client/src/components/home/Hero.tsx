      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          >
            ...
            >
              <span className="text-[#C17A50] font-medium text-sm">
            ...
            >
              <span className="block">Find the Scen</span>
              <motion.span
            ...
            >
              <span className="italic text-[#C17A50] font-semibold">
                "Because fragrance isn't just a smell—it's a signature."
              </span>{" "}
              Discover the aroma that reflects your personality and becomes part
              of your story.
            </motion.p>
            ...
            >
              <Link href="/quiz">
                <Button className="bg-[#DA7346] hover:bg-[#DA7346] text-white py-3 px-8 rounded-md text-base font-medium group relative overflow-hidden transition-all duration-300">
          ...
          <motion.div
            variants={fadeInUp}
            className="w-full md:w-1/2 relative h-[300px] md:h-[600px]"
          >
