      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            <h3 className="text-xl font-playfair font-semibold mb-4">Answer Questions</h3>
          ...
          >
            ...
            <h3 className="text-xl font-playfair font-semibold mb-4">Reveal Your Zodiac</h3>
            <p className="text-muted-foreground">
          ...
          >
            ...
            <h3 className="text-xl font-playfair font-semibold mb-4">Find Your Match</h3>
            <p className="text-muted-foreground">
